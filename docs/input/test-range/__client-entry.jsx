...
/*
  ...
  Main client entry point for snapsite snapsite route '78f0037c'.
...
console.log("snapsite client app initializing on route '/test-range'...");
console.log("Page [snapsite :: test range] (78f0037c) Copyright (C) 2016 Encapsule.io");
