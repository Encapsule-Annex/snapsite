...
/*
  ...
  Main client entry point for snapsite snapsite route '487a72fa'.
  This script will be called when the HTML5 document published at
  URL 'http://github.com/Encapsule/snapsite/testsite/about/directions' loads in your browser.
...
console.log("snapsite client app initializing on route '/testsite/about/directions'...");
console.log("Page [snapsite :: directions] (487a72fa) Copyright (C) 2016 Encapsule.io");
