...
/*
  ...
  Server UX render entry entry point for snapsite snapsite route '37db97ea'.
...
module.exports = function() {
    ...
    while (!inBreakScope) {
        ...
        try {
            ...
            errors.unshift("Failed to render '/testsite/about/directions/test1/test4/baz' due to error:");
            break;
        }
        break;
    }
