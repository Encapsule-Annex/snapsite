...
/*
  ...
  Server UX render entry entry point for snapsite snapsite route '83f6fa72'.
...
module.exports = function() {
    ...
    while (!inBreakScope) {
        ...
        try {
            ...
            errors.unshift("Failed to render '/testsite/about/directions/test1/test4/foo' due to error:");
            break;
        }
        break;
    }
