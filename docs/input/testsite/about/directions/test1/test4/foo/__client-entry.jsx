...
/*
  ...
  Main client entry point for snapsite snapsite route '83f6fa72'.
  This script will be called when the HTML5 document published at
  URL 'http://github.com/Encapsule/snapsite/testsite/about/directions/test1/test4/foo' loads in your browser.

  Produced by Encapsule/snapsite v0.0.8 Sat Feb 27 2016 18:21:15 GMT-0800 (PST)
  Site build instance: [1456626075217 TE1CMulST1-UgK6Fk-9LQg]
*/
// ======================================================================
...
console.log("snapsite client app initializing on route '/testsite/about/directions/test1/test4/foo'...");
console.log("Page [snapsite :: CC directions] (83f6fa72) Copyright (C) 2016 Encapsule.io");
