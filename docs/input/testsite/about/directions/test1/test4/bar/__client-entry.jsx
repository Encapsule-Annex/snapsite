...
/*
  ...
  Main client entry point for snapsite snapsite route '2c7b2441'.
  This script will be called when the HTML5 document published at
  URL 'http://github.com/Encapsule/snapsite/testsite/about/directions/test1/test4/bar' loads in your browser.
...
console.log("snapsite client app initializing on route '/testsite/about/directions/test1/test4/bar'...");
console.log("Page [snapsite :: Xdirections] (2c7b2441) Copyright (C) 2016 Encapsule.io");
