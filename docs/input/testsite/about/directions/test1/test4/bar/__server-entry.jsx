...
/*
  ...
  Server UX render entry entry point for snapsite snapsite route '2c7b2441'.
...
module.exports = function() {
    ...
    while (!inBreakScope) {
        ...
        try {
            ...
            errors.unshift("Failed to render '/testsite/about/directions/test1/test4/bar' due to error:");
            break;
        }
        break;
    }
