...
/*
  ...
  Server UX render entry entry point for snapsite snapsite route '3e668e9e'.
...
module.exports = function() {
    ...
    while (!inBreakScope) {
        ...
        try {
            ...
            errors.unshift("Failed to render '/testsite/about/directions/test1/test4' due to error:");
            break;
        }
        break;
    }
