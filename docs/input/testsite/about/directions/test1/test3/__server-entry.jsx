...
/*
  ...
  Server UX render entry entry point for snapsite snapsite route 'a33b3793'.
...
module.exports = function() {
    ...
    while (!inBreakScope) {
        ...
        try {
            ...
            errors.unshift("Failed to render '/testsite/about/directions/test1/test3' due to error:");
            break;
        }
        break;
    }
