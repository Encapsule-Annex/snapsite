...
/*
  ...
  Main client entry point for snapsite snapsite route '445292c9'.
  This script will be called when the HTML5 document published at
  URL 'http://github.com/Encapsule/snapsite/testsite/about/directions/test1' loads in your browser.
...
console.log("snapsite client app initializing on route '/testsite/about/directions/test1'...");
console.log("Page [snapsite :: TEST1] (445292c9) Copyright (C) 2016 Encapsule.io");
